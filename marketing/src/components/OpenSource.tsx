    ...
    <section id="open-source" className="py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-pf-primary/10 text-pf-primary mb-6">
              Open Source
            </span>
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={item.title} className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-pf-primary shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-white bg-pf-dark rounded-xl hover:bg-pf-surface-light transition-colors border border-[rgba(99,102,241,0.15)]"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-pf-text border border-[rgba(99,102,241,0.15)] rounded-xl hover:bg-white/5 transition-colors"
              >
                Self-Hosting Guide
              </a>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-pf-surface border border-[rgba(99,102,241,0.15)] rounded-2xl p-6">
            ...
            <div className="bg-pf-dark rounded-2xl p-5 border border-[rgba(99,102,241,0.15)]">
