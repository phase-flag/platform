...
export default function Pricing() {
  return (
    <section id="pricing" className="bg-pf-surface border-y border-[rgba(91,186,167,0.15)] py-20 lg:py-28">
          ...
          {tiers.map((tier) => (
            <div
              ...
              className={`rounded-2xl p-8 transition-all ${
                tier.highlighted
                  ? 'bg-pf-surface-light border-2 border-pf-mint shadow-xl shadow-pf-mint/10 relative'
                  : 'bg-pf-surface border border-[rgba(91,186,167,0.15)]'
              }`}
            >
              {tier.highlighted && (
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 text-xs font-medium text-white bg-pf-mint rounded-full">
                  Most Popular
                </span>
              )}
              ...
              {tier.priceDetail === 'forever' && (
                <p className="text-sm text-pf-mint font-medium mb-4">Free forever</p>
              )}
              ...
              <a
                ...
                className={`block text-center px-6 py-3 text-sm font-medium rounded-xl transition-all ${
                  tier.highlighted
                    ? 'text-white bg-pf-mint hover:bg-pf-mint-light shadow-lg shadow-pf-mint/20'
                    : 'text-pf-text border border-[rgba(91,186,167,0.15)] hover:bg-white/5'
                }`}
              >
                {tier.cta}
              </a>
