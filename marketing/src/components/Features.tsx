const features = [
  ...
  },
  {
    ...
    color: 'bg-pf-primary/10 text-pf-primary',
  },
  {
    title: '19 SDKs',
  ...
  },
  {
    ...
    description: 'SSO/SAML, fine-grained RBAC, audit logs, compliance exports, environment freeze windows, and break-glass workflows.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: '11 operators including regex, semver comparison, and list membership. Build precise targeting with segment reuse.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="features" className="py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-pf-text-muted text-lg leading-relaxed">
            A complete feature flag platform from local evaluation to enterprise governance,
            with the tooling to ship confidently at any scale.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            ...
            >
              ...
              <h3 className="font-heading text-base font-medium uppercase tracking-wider text-white mb-2">
                {feature.title}
              </h3>
