...
export default function EvaluationDemo() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* Operators reference */}
      <div className="mt-10 bg-[#162029] border border-[rgba(91,186,167,0.15)] rounded-2xl p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            <div key={item.op} className="bg-[#1C2D38] rounded-lg p-3 border border-[rgba(91,186,167,0.15)]">
              <code className="text-xs font-mono text-pf-mint">{item.op}</code>
