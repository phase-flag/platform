...
class ExperimentDB(Base):
    ...
    goals = relationship("ExperimentGoalDB", back_populates="experiment", cascade="all, delete-orphan", lazy="selectin")
    results = relationship("ExperimentResultDB", back_populates="experiment", cascade="all, delete-orphan", lazy="selectin")
